  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-5">
        <h3><i class="fas fa-chalkboard-teacher"></i> DAFTAR DOSEN</h3>
        <hr>

        <a href="tambah-dosen.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>TAMBAH DATA DOSEN</a>
            ...
            <?php if ($result->num_rows > 0) : ?>
              <?php while ($row = $result->fetch_assoc()) : ?>
                ...
                <td><?= $row['no_hp']; ?></td>
                  ...
                  <td><a href="update-dosen.php?id=<?=$row['id']?>"><i class="fas fa-edit  pt-2 " data-toggle="tooltip" title="Edit"></i></a></td>
                  <td><a href="aksi/dosen/delete_dosen.php?id=<?=$row['id']?>"><i class="fas fa-trash-alt pt-2 " data-toggle="tooltip" title="Delete"></i></a></td>
                </tr>
              <?php endwhile; ?>
            <?php endif; ?>
          </tbody>
