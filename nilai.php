  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-5">
        <h3><i class="fas fa-chalkboard-teacher"></i> DAFTAR NILAI MAHASISWA</h3>
        <hr>

        <a href="tambah-nilai.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>TAMBAH NILAI MAHASISWA</a>
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <?php include_once "./aksi/nilai/ambil_nilai.php" ?>
            <?php if ($result->num_rows > 0) : ?>
              <?php while ($row = $result->fetch_assoc()) : ?>
                ...
                <td><?= $row['nilai_akhir']; ?></td>
                  ...
                  <td><a href="update-nilai.php?id=<?=$row['id']?>"><i class="fas fa-edit  pt-2 " data-toggle="tooltip" title="Edit"></i></a></td>
                  <td><a href="aksi/nilai/delete_nilai.php?id=<?=$row['id']?>"><i class="fas fa-trash-alt pt-2 " data-toggle="tooltip" title="Delete"></i></a></td>
                </tr>
              <?php endwhile; ?>
            <?php endif; ?>
          </tbody>
