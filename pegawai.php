            ...
            <?php if ($result->num_rows > 0) : ?>
              <?php while ($row = $result->fetch_assoc()) : ?>
                ...
                <td><?= $row['tempat_tanggal_lahir']; ?></td>
                  ...
                  <td><a href="update-pegawai.php?id=<?=$row['id']?>"><i class="fas fa-edit  pt-2 " data-toggle="tooltip" title="Edit"></i></a></td>
                  <td><a href="aksi/pegawai/delete_pegawai.php?id=<?=$row['id']?>"><i class="fas fa-trash-alt pt-2 " data-toggle="tooltip" title="Delete"></i></a></td>
                </tr>
              <?php endwhile; ?>
            <?php endif; ?>
          </tbody>
